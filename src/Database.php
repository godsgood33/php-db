...
final class Database {
  ...
  public function __construct(&$dbh = null) {
    if(!is_null($dbh) && is_a($dbh, "mysqli")) {
      ...
      $this->c = new mysqli(DB_SERVER, DB_USER, DB_PWD, DB_SCHEMA);
    }
   ...
   *          &nbsp;&nbsp;array(<br />
   *          &nbsp;&nbsp;&nbsp;&nbsp;'field' => 'field_name',<br />
   *          &nbsp;&nbsp;&nbsp;&nbsp;'op' => '=', // (common operations or IN, NOT_IN, BETWEEN, LIKE, NOT_LIKE, IS, & IS_NOT constants)<br />
